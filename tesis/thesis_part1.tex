...
\affiliation{%
  Master en F\'isica Te\'orica, Universidad Complutense de Madrid, 28040 Madrid, Spain
}
...
transfer phase.
Second, we present an extensive analysis of the hybrid analog-digital protocol
...
We provide a detailed comparison of both approaches, contrasting their physical
...
$T = \pi$), the performance of the different CD approximations is~\cite{Romero2024}:
...
The author acknowledges the supervision and guidance provided throughout this
project. Numerical simulations were performed using Python with NumPy,
