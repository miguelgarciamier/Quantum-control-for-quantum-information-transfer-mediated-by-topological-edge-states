...
multi-domain chain with fidelity $0.998$ while shortening the transfer time by
...
\begin{figure*}[!t]
  ...
  moves off-centre, the coupling asymmetry $\JLS \neq \JSR$ caps the population
...
\begin{figure*}[!t]
  ...
  quasi-centre ($\sim 1/2$), one-third ($\sim 1/3$) and one-quarter ($\sim 1/4$)
  ...
  exponentially with the displacement from the centre, consistent with the
...
\begin{figure*}[!t]
  ...
  the quasi-centre ($j_{\mathrm{DW}} = 11$, peak $f \approx 0.64$) and at a
...
\begin{figure}[tb]
  ...
  $f\approx0.64$ near the quasi-centre and collapses to $f\lesssim0.004$ for
...
\caption{Validation of CTAP on the full $L=21$ SSH Hamiltonian~(1).
  ...
  whereas the Rabi fidelity collapses away from the centre. Annotated transfer
...
0.95\,\kappa$. The pinning is thus a sharp, symmetry-selective effect: only
