...
\begin{itemize}
  ...
  \item \emph{Figs.~\ref{fig:ctap_comparison}--\ref{fig:ctap_asymmetry}
    (asymmetry sweep, effective three-level)}: same $\sigma=0.18\,T$,
    $t_R=T/3$, $t_L=2T/3$; $T=1500$ for bare CTAP and $T=600$ for
    CD-assisted (\texttt{ctap\_asymmetric.py}).
