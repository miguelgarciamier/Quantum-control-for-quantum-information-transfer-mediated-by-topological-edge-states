...
Figure~\ref{fig:ctap_comparison} reports the result. Bare CTAP recovers
$f > 0.99$ wherever $\rho \lesssim 8$ ($|\ell_1 - \ell_2| \lesssim 6$) and
reaches $f \approx 0.91$ at $\rho = 32$ ($j_{\mathrm{DW}} = 5$) for sufficiently
long pulses---more than two orders of magnitude above the Rabi bound
$f_{\max} = 0.004$. Adding the counterdiabatic term~(\ref{eq:hcd_effective})
raises this to $f \approx 0.97$.
